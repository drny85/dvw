        ...
        {feed.feedType === "feed" && (
          ...
          >
            <Text
              ...
              fontFamily="QSLight"
            >
              {feed.numberOfLines} {feed.numberOfLines === 1 ? "line" : "lines"}{" "}
              {feed.saleType === "direct" ? "direct sale" : "click to call"}
            </Text>
          </View>
        )}
        {feed.feedType === "quote" && (
        ...
        <AnimatePresence>
          {pressAction && (
            ...
            >
              ...
              >
                <TouchableOpacity onPress={() => onDeletePress(feed.id!)}>
                  <FontAwesome name="trash-o" size={30} color={deleteColor} />
                </TouchableOpacity>
                <TouchableOpacity>
